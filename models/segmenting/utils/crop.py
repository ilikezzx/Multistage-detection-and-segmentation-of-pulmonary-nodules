...
def crop_patch(images, center, depth=64, radius=64):
    ...
    if z_center + 32 > depth_img:
        _z_center = depth_img - 32
    elif z_center < 32:
        _z_center = 32
    else:
        _z_center = z_center

    if y_center + 32 > h_img:
        _y_center = h_img - 32
    elif y_center < 32:
        _y_center = 32
    else:
    ...
    real_center = [_z_center, _y_center, _x_center]
    # print(real_center)
    ...
    return (patch, real_center, z_center-(_z_center-depth//2))
